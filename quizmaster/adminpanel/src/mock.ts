import { Backend, CategoriesDto, QuizStatsDto } from "./api/restBackend";
...
export const testBackend = (): Backend => {
  return {
    ...
    acceptAnswer(category: string, answerId: string): Promise<CategoriesDto> {
      return Promise.resolve(testCategoryData);
    },
  };
};
  ...
  categories: [
...

    {
      ...
      pendingAnswers: [
        ...
        {
          teamName: "testteam1 med ganske langt navn",
          answerId: "1234",
          answer: "google.com",
        },
